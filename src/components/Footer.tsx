...
const Footer = () => {
  ...
  return (
    <footer className=" relative bg-white dark:bg-black text-white py-10  overflow-hidden ">
      <div className="container mx-auto px-6 flex flex-col gap-10 text-center relative z-10 ">
        <motion.p
